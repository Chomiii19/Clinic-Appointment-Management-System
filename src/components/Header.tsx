    ...
    <header className="flex items-center justify-between w-full">
      ...
      <div className="flex items-center lg:gap-5">
        <div className="relative">
          ...
          {openDropdown && (
            <div className="bg-system-white p-2 rounded-lg dark:bg-system-black flex flex-col gap-3 absolute shadow-md w-44 -bottom-30 right-0 text-zinc-600 dark:text-zinc-400 z-40">
              <Link
                to={`/users/${user?._id}`}
              ...
              <Link
                ...
                className="cursor-pointer flex items-center gap-2 transition-colors duration-150 ease-in hover:text-zinc-950 hover:dark:text-zinc-100"
              >
                <UserRoundPen className="w-5" /> Edit Account
              </Link>
              <button
